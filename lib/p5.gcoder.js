...
class Dicer {
  ...
  print() {
    ...
    // }
    // else {
    //   alert('you need to give access to a serial port first!');
    // }
  }
  ...
  render() {
    ...
    this.model = new p5.Geometry(50, 50);
  ...
  introLine() {
    ...
    this.moveExtrude(0.1, 200, 0.3, 1500);
    this.move(0.4, 200.0, 0.3, 5000.0);
    this.moveExtrude(0.4, 20.0, 0.3, 1500);
  }
