        ...
        if (_fab.isPrinting) {
            ...
            if (_fab.serialResp.slice(-1) == "\n") {
                ...
                if (_fab.serialResp.search(" Count ") > -1) {
                    ...
                    _fab.reportedPos = _fab.serialResp
                        .split(" Count ")[0]
                        .trim();
                }
                _fab.serialResp = "";
        ...
        if (this.importedGCode) {
            ...
            for (let command of this.importedGCodeCommands) {
                ...
                if (
                    ...
                    vertex(
                        importedToolpathPos.x,
                        importedToolpathPos.y,
                        importedToolpathPos.z,
                    );
                    vertex(coords.x, coords.y, coords.z);
                    importedToolpathPos = importedToolpathPos.set([
                        coords.x,
                        coords.y,
                        coords.z,
                    ]);
